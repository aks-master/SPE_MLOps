...
def main():
    try:
        ...
        if not bucket_name or not accesskey or not secretkey:
            raise EnvironmentError("Environment variables for S3 credentials are not set.")
        print(f"bucket_name: {bucket_name}, accesskey: {accesskey}, secretkey: {secretkey}");
